...
extension StartingContact {
    static var allContacts: [StartingContact] {
        [
            StartingContact(id: "contact.banker-bias", name: "The Dealer's Nephew", flavor: "He keeps seeing things he should not see.", summary: "Card Reader. Starts with Bent Corner: stage starts reveal the opening read.", startingModifiers: ["core.opening-tell"], shopBiasTags: [.shoeVision, .shoeControl, .banker], difficultyRating: "Low Risk", recommendedArchetype: "Card Reader"),
            StartingContact(id: "contact.player-surge", name: "The Comp Queen", flavor: "Somehow, the house keeps paying for her mistakes.", summary: "Comp Scammer. Starts with Comp Points: winning wagers feed the shop.", startingModifiers: ["core.lucky-chip"], chipsAdjustment: 1, shopBiasTags: [.economy, .comeback, .player], difficultyRating: "Easy", recommendedArchetype: "Comp Scammer"),
            StartingContact(id: "contact.opening-tell", name: "The Red Marker", flavor: "Already banned from two rooms and welcomed in three more.", summary: "Heat Gambler. Starts with All-In Alibi: Heat pressure can convert into value.", startingModifiers: ["core.clean-hands"], heatAdjustment: 1, shopBiasTags: [.heat, .betControl, .economy], difficultyRating: "High Risk", recommendedArchetype: "Heat Gambler", cashRewardMultiplierPercent: 90),
            StartingContact(id: "contact.tie-insurance", name: "The Tie Clerk", flavor: "Bad odds, better brakes.", summary: "Comp Scammer pivot. Starts with Tie Insurance for safer long-shot attempts.", startingModifiers: ["core.tie-insurance"], bankrollAdjustmentCents: -1_000, shopBiasTags: [.tie, .comeback, .shoeVision], difficultyRating: "Hard", recommendedArchetype: "Comp Scammer"),
            StartingContact(id: "contact.lucky-chip", name: "The Floor Host", flavor: "A quiet nod from the boxman.", summary: "Balanced route. Starts with Banker Bias for stable table pressure.", startingModifiers: ["core.banker-bias"], shopBiasTags: [.banker, .shoeVision, .economy], difficultyRating: "Normal", recommendedArchetype: "Hybrid"),
            StartingContact(id: "contact.clean-hands", name: "The Backroom Pivot", flavor: "A quick side switch before the table notices.", summary: "Card Reader pivot. Starts with Player Surge for early Player-side tempo.", startingModifiers: ["core.player-surge"], shopBiasTags: [.player, .shoeVision, .comeback], difficultyRating: "Medium", recommendedArchetype: "Card Reader")
        ]
    }
